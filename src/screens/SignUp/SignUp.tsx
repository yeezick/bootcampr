    ...
    <div className="signup-container">
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        <div className="form-input">
          ...
          <input type="text" name="firstName" placeholder="First Name"  onChange={handleChange} value={firstName} autoComplete="off" required />
        </div>
        <div className="form-input">
          <label>Last Name</label>
          <input type="text" name="lastName" placeholder="Last Name" onChange={handleChange} value={lastName} autoComplete="off" required />
        </div>
        <div className="form-input">
          <label>Email</label>
          <input type="email" name="email" placeholder="Email"  onChange={handleChange} value={email} autoComplete="off" required />
        </div>
        <div className="pwd-input">
          <div>
            ...
            <input type={inputType} name="password" placeholder="Password" onChange={handleChange} value={password} autoComplete="off" />
          </div>
        </div>
        <div className="form-input">
          <label>Confirm Password</label>
          <input type={inputType} name="confirmPassword" placeholder="Confirm Password" onChange={handleChange} value={confirmPassword}  autoComplete="off" />
        </div>
