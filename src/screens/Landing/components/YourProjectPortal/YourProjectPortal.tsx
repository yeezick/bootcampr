  ...
  return (
    <div className='your-project-portal'>
      ...
      <div className='details'>
        <DetailsContent
          ...
          textContent=' The project prompt tells you the problem, user groups to consider,
    ...
    solution!'
        ...
        <DetailsContent
          ...
          textHeader='Team'
          textContent=' Get to know your team of 3 software engineers and 2 UX Designers.
    ...
    say hi and introduce yourself!'
        ...
        <DetailsContent
          ...
          textHeader='Calendar'
          textContent=' Communication with your team is important. We provide a calendar
        ...
        <DetailsContent
          ...
          textContent='   Most companies use a work management tool. We’ve created one you
        ...
        <DetailsContent
          ...
          textContent=' You’ve done the work and deployed your project.We’re stoked to see
