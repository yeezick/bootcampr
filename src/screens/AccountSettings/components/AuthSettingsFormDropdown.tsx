import { AuthSettingsFormDropdownProps, EmailFormData, PasswordFormData } from '../../../utilities/types/AccountSettingsInterface'
...
const AuthSettingsFormDropdown = ({ fields, type }: AuthSettingsFormDropdownProps): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (emailDropDownActive) validateEmailDropdown(temp, setDisableButton)
    else validatePasswordDropdown(temp, setDisableButton)
