// TODO:
// - consolidate to only timezones we're allowing - DONE
// - consider redesigning structure to be more workable for our use case
// - This may mean writing a function for a one time universal reformat

// TODO: this function can be removed now
...
// TODO: I think this can be deleted now that the conversion has been done
const dayJSTimezoneData = [
  {
...
// Rename and confirm that this is necessary - Does DayJS have a way to get user's utc from the string zone name?
export const restructuredData = {
  'America/Adak': {
    label: 'America/Adak (GMT-10:00)',
    name: '(GMT-10:00) Adak',
    utc: '-10:00',
