export const projectBriefContent = [
  {
    title: 'Client Profile',
    content: (
      <p>
        The client for this project is a newly established restaurant located in
        a bustling urban area. This restaurant specializes in fusion cuisine,
        combining flavors from various cultures to create unique and innovative
        dishes. They aim to provide a modern dining experience with a focus on
