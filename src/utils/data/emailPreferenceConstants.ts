...
export const emailPreferenceOptions = {
  projectUpdates: {
    ...
    description:
      'Anything project related. This includes meeting invites and task management ticket updates.',
  },
  chatNotifications: {
  ...
  surveysAndFeedback: {
    ...
    description:
      'We love feedback and may ask you how we can improve to better help you.',
  },
  bootcamprUpdates: {
    title: 'Bootcampr updates',
    description:
      "Stay up-to-date on new and improved features as they're released!",
  },
  eventInvitations: {
    title: 'Event invitations',
    description:
      "We'll invite you to virtual speaking events with professional UX Designers, Software Engineers, and Product Managers",
  },
  newsletters: {
    title: 'Newsletters',
